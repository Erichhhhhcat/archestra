...
ALTER TABLE "interactions" ADD CONSTRAINT "interactions_profile_id_agents_id_fk" FOREIGN KEY ("profile_id") REFERENCES "public"."agents"("id") ON DELETE set null ON UPDATE no action;